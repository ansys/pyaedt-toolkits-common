...
The `examples/toolkit/toolkit_webapp <https://github.com/ansys/pyaedt-toolkits-common/tree/main/examples/toolkit_webapp>`_
folder contains all files for creating a toolkit using the PyAEDT Common Toolkit backend and an example of a Python
framework that lets the user to turn scripts into interactive web apps.
...
1. **Access the example**: Navigate to the `examples/toolkit_webapp <https://github.com/ansys/pyaedt-toolkits-common/tree/main/examples/toolkit/pyaedt_toolkit>`_
   folder.
